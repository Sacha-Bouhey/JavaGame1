...
public class Game_Start {
    ...
    public static void initLocation() {
        ...
        Location_init.put("Starting village", new Location("Stating village", 0, 0, true));
        Location_init.put("Forest", new Location("Forest", 1, 0, false));
        Location_init.put("Cave", new Location("Cave", 0, 1, false));
        Location_init.put("Castle", new Location("Castle", 0, -1, false));
    }
